            ...
            if (isExternalStorageDocument(uri)) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
                        String sdCardPath = storageVolume.getDirectory().getPath();
                    }

                    String sdCardStorage = System.getenv("SECONDARY_STORAGE");
                    ...
                    String sdCardPath = primaryExternalStorage.getAbsolutePath();
